...
open class DeliveryOrderList : BaseObservable() {
    ...
    var freight: String? = null
        set(freight) {
            field = freight
            notifyChange(shy.car.sdk.BR.freight)
        }
    ...
    var goodsInfo: String? = null
        set(goodsInfo) {
            field = goodsInfo
            notifyChange(shy.car.sdk.BR.goodsInfo)
        }
    ...
    var fromAddress: String? = null
        set(fromAddress) {
            field = fromAddress
            notifyChange(shy.car.sdk.BR.fromAddress)
        }
    ...
    var toAddress: String? = null
        set(toAddress) {
            field = toAddress
            notifyChange(shy.car.sdk.BR.toAddress)
        }
    ...
    var status: Int = 0
        set(status) {
            field = status
            notifyChange(shy.car.sdk.BR.status)
        }
    ...
    var statusName: String? = null
        set(statusName) {
            field = statusName
            notifyChange(shy.car.sdk.BR.statusName)
        }
    @SerializedName("user")
    @get:Bindable
    var user: UserBean? = null
        set(user) {
            field = user
            notifyChange(shy.car.sdk.BR.user)
        }
    @Transient
    ...
    open class UserBean : Observable {
        ...
        var name: String? = null
            set(name) {
                field = name
                notifyChange(shy.car.sdk.BR.name)
            }
        ...
        var phone: String? = null
            set(phone) {
                field = phone
                notifyChange(shy.car.sdk.BR.phone)
            }
        ...
        var avatar: String? = null
            set(avatar) {
                field = avatar
                notifyChange(shy.car.sdk.BR.avatar)
            }
        ...
        var rankText: String? = null
            set(rankText) {
                field = rankText
                notifyChange(shy.car.sdk.BR.rankText)
            }
        @Transient
        private var propertyChangeRegistry: PropertyChangeRegistry? = PropertyChangeRegistry()

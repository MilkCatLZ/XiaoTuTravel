...
//            e.printStackTrace();
    ...
    public static void showLoadingView(
        ...
        @Nullable OnDismissListener dismissListener,
        @Nullable OnCancelListener cancelListener) {
        showLoadingView(activity, dismissListener, cancelListener, false);// 默认点击外面不可以取消
    }
    ...
    public static void showLoadingView(
        ...
        if (activity instanceof Activity)
            showLoadingView((Activity) activity, dismissListener, cancelListener, false);// 默认点击外面不可以取消
    }
    ...
    public static void showLoadingView(
        @NonNull Context activity) {
        if (activity instanceof Activity)
            showLoadingView((Activity) activity, null, null, false);// 默认点击外面不可以取消
    }
    ...
    public static void showLoadingView(
        @NonNull Activity activity) {
        if (activity instanceof Activity)
            showLoadingView(activity, null, null, false);// 默认点击外面不可以取消
    }

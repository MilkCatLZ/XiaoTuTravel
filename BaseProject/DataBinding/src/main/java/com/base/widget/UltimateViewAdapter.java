 ...
 */
public abstract class UltimateViewAdapter<VH extends RecyclerView.ViewHolder> extends SwipeMenuAdapter<VH>
    ...
    protected boolean detectDispatchLoadMoreDisplay(final int data_size_before_remove, final int display_size_before_remove) {
        if (data_size_before_remove == 0) {
            if (display_size_before_remove == 2) {
                ...
                if (mEmptyViewPolicy == com.base.widget.UltimateRecyclerView.EMPTY_KEEP_HEADER_AND_LOARMORE) {

                } else if (mEmptyViewPolicy == com.base.widget.UltimateRecyclerView.EMPTY_KEEP_HEADER) {
                    removeDispatchLoadMoreView();
                } else if (mEmptyViewPolicy == com.base.widget.UltimateRecyclerView.EMPTY_CLEAR_ALL) {
                    removeDispatchLoadMoreView();
                }
                ...
                if (mEmptyViewPolicy == com.base.widget.UltimateRecyclerView.EMPTY_KEEP_HEADER_AND_LOARMORE) {
                    ...
                    notifyDataSetChanged();
                } else if (mEmptyViewPolicy == com.base.widget.UltimateRecyclerView.EMPTY_SHOW_LOADMORE_ONLY) {
                    notifyDataSetChanged();
                }
                return true;
            } else {
